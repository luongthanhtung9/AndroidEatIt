package com.example.androideatit.common.customview;
...
import com.example.androideatit.callback.IMyButtonClickListener;
...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton {
        ...
        public void onDraw(Canvas c, RectF recF, int pos) {
            Paint p = new Paint();
            p.setColor(color);
            c.drawRect(recF, p);
            ...
            Rect r = new Rect();
            float cHeight = recF.height();
            float cWidth = recF.width();
