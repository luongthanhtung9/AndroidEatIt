...
import com.example.androideatit.remote.ICouldFunctions;
import com.example.androideatit.remote.RetrofitICouldClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ICouldFunctions cloudFunctions;
    ...
    private void init() {
        ...
        cloudFunctions = RetrofitICouldClient.getIntance().create(ICouldFunctions.class);
    ...
    private void showRegisterDialog(FirebaseUser user) {
        ...
        EditText edtAddress = itemView.findViewById(R.id.edt_address);
        ...
        builder.setNegativeButton(getResources().getText(R.string.cancel), (dialogInterface, i) -> {
            dialogInterface.dismiss();
        });

        builder.setPositiveButton(getResources().getText(R.string.REGISTER), (dialogInterface, i) -> {
            if (TextUtils.isEmpty(edtName.getText().toString())) {
                ...
                Toast.makeText(this, getResources().getString(R.string.please_enter_your_address), Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            userModel.setPhone(edtPhone.getText().toString());
